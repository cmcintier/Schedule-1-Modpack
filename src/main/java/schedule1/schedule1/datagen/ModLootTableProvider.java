                ...
                block -> this.applyExplosionDecay(block,
                        LootTable.builder()
                                .pool(LootPool.builder()
                                        .conditionally(
                                                BlockStatePropertyLootCondition.builder(ModBlocks.GRANDADDY_PURPLE_BUSH).properties(StatePredicate.Builder.create().exactMatch(GrandaddyPurpleBushBlock.AGE, 4))
                                        )
